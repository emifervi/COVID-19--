...
start			: PROGRAM ID SEMI gb_var_block? func* main ;
	
gb_var_block	: VAR (tipo ids_decl SEMI)+ ;
var_block		: VAR (tipo_atom ids_decl SEMI)+ ;
...
covid 			: load_file | load_data | avg | moda | rango | variance | std_dev | maxi | mini
				| plot | histogram | correl ;
	
load_file		: LOAD_FILE PARENS_L operand PARENS_R ;
load_data		: LOAD_DATA PARENS_L ident COMMA ident COMMA ident PARENS_R ;
avg 			: AVG PARENS_L ident COMMA operand PARENS_R ;
moda 			: MODE PARENS_L ident COMMA operand PARENS_R ;
rango 			: RANGE PARENS_L ident COMMA operand PARENS_R ;
variance 		: VARIANCE PARENS_L ident COMMA operand PARENS_R ;
std_dev 		: STD_DEV PARENS_L ident COMMA operand PARENS_R ;
maxi 			: MAX PARENS_L ident COMMA operand PARENS_R ;
mini 			: MIN PARENS_L ident COMMA operand PARENS_R ;
plot 			: PLOT PARENS_L ident COMMA operand COMMA operand PARENS_R ;
histogram 		: HISTOGRAM PARENS_L ident COMMA operand COMMA expr PARENS_R ;
correl 			: CORREL PARENS_L ident COMMA operand COMMA operand PARENS_R ;
